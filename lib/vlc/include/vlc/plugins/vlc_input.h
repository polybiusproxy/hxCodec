                                                           ...
                                                           size_t i_data)
{
    ...
    if (unlikely(a->psz_name == NULL || a->psz_mime == NULL || a->psz_description == NULL || (i_data > 0 && a->p_data == NULL)))
    {
 ...
 * \see input_Create
 */
static inline input_thread_t *input_CreateAndStart(vlc_object_t *parent,
