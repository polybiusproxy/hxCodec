...
#define AOUT_FMTS_SIMILAR(p_first, p_second) ( \
    ((p_first)->i_rate == (p_second)->i_rate) && ((p_first)->channel_type == (p_second)->channel_type) && ((p_first)->i_physical_channels == (p_second)->i_physical_channels) && ((p_first)->i_chan_mode == (p_second)->i_chan_mode))
...
#define AOUT_FMT_HDMI(p_format) \
  ((p_format)->i_format == VLC_CODEC_EAC3 || (p_format)->i_format == VLC_CODEC_TRUEHD || (p_format)->i_format == VLC_CODEC_MLP)
