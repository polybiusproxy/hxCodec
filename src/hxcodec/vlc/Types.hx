...
typedef LibVLC_Video_Unlock_CB = cpp.Callable<(data:cpp.RawPointer<cpp.Void>, id:cpp.RawPointer<cpp.Void>, p_pixels:cpp.RawPointer<cpp.Void>) -> Void>;
typedef LibVLC_Video_Display_CB = cpp.Callable<(opaque:cpp.RawPointer<cpp.Void>, picture:cpp.RawPointer<cpp.Void>) -> Void>;
typedef LibVLC_Audio_Play_CB = cpp.Callable<(data:cpp.RawPointer<cpp.Void>, samples:cpp.RawConstPointer<cpp.Void>, count:UInt, pts:cpp.Int64) -> Void>;
...
typedef LibVLC_Audio_Setup_CB = cpp.Callable<(data:cpp.RawPointer<cpp.RawPointer<cpp.Void>>, chroma:cpp.CharStar, rate:cpp.RawPointer<UInt>, channels:cpp.RawPointer<UInt>) -> Int>;
typedef LibVLC_Audio_Cleanup_CB = cpp.Callable<(data:cpp.RawPointer<cpp.Void>) -> Void>;
